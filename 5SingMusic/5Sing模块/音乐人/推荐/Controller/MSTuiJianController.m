...
#import "MSTuiJianController.h"
#import "AFNetworking.h"
#import "TQMSModel.h"
#import "TQMSCell.h"
@interface MSTuiJianController ()

@end

@implementation MSTuiJianController
...
-(void)creatData{
    ...
    [manager GET:TjMusician parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
