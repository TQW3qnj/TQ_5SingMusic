...
#import "MSFameController.h"
#import "AFNetworking.h"
#import "TQMSCell.h"
#import "TQMSModel.h"
@interface MSFameController ()

@end

@implementation MSFameController
...
-(void)creatData{
    ...
    [manager GET:MRT_ZOB_Musician parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
